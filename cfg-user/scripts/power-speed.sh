...
doas sysctl dev.hwpstate_intel.0.epp=40   2> /dev/null
doas sysctl dev.hwpstate_intel.1.epp=50   2> /dev/null
doas sysctl dev.hwpstate_intel.2.epp=60   2> /dev/null
doas sysctl dev.hwpstate_intel.3.epp=70   2> /dev/null
doas sysctl dev.hwpstate_intel.4.epp=80   2> /dev/null
doas sysctl dev.hwpstate_intel.5.epp=90   2> /dev/null
